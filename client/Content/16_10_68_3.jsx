...
const Content = ({
  ...
  useEffect(()=>{
      ...
      if(draggingElement.container && draggingElement.columns){
        const element = lodash.cloneDeep(draggingElement)
  ...
  const handleDrop = (e)=>{
    ...
    added()
  //   if (!dropTarget?.type) {
  //     const elem = lodash.cloneDeep(draggingElement());
  ...
  //   if (dropTarget.type === "SECTION") dropNewSection();
  //   else dropNewElement();
  }
  ...
  const setDrop = (i, t,b = false) => {
    dropTarget = { index: i, type: t, isLast: b };
  };
  ...
  const updateHoverFromPoint = (x, y, type, element) => {
    ...
    if (ghostRef.current) {
      ...
      const hasdropTarget = dropTarget && dropTarget.type && (dropTarget.type === "SECTION" 
      ? typeof dropTarget.index === "number"
      : dropTarget.index && Number.isInteger(dropTarget.index.conI) && Number.isInteger(dropTarget.index.colI) && Number.isInteger(dropTarget.index.eleI)
    )
