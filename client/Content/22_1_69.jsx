import React, {
  ...
  const Content = ({
    handleDropElement,
    openOffcavanas,
    offcanvasID,layouts,setLayout,theme,page,setPage
  }) => {
    ...
    const SortableSpanItem = ({
      ...
      return (
        ...
        >
          {isMiniSpan ? (
            <div className={`col-span-12`} ref={(el)=>{
            ...
            <div
              ...
              ref={(el)=>{
                setSpnRef(IDX,idx,sidx,el)
                setMspnRef(IDX,idx,sidx,0,null)
              }}
            >
              {hover === id && !activeID && (
                <div
    ...
    function OptionButtonGroup({
      ...
      if (["Container", "Column","Header"].includes(offcavanas)) {
        return (
          <div
