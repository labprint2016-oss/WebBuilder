...
function Navbar({ handleDragElement,isDark,setIsDraggingNewElement,setOption}) {
  ...
  const [data, setData] = useState({
    ...
    Elements: [
      ...
      { label: "Span", icon: "dashboard_customize" },
                  ...
                  {data.Elements.map((items, index) => (
                    <div
                      ...
                      onDragStart={(e) => {
                        ...
                        setIsDraggingNewElement(true)
                      }}

                      onDragEnd={(e)=>{
                        handleDragElement(null)
                        setIsDraggingNewElement(false)
                      }}
                    >
                      {" "}
